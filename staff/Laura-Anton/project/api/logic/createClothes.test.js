...
const clothes = [
...

    {
        ...
        size: 'S',
        category: 'CAMISAS/CAMISETAS',
        tittle: 'CAMISETA CORTA HELLO KITTY' 
    },
    {
...

    {
        ...
        size: 'S',
        category: 'TOP',
        tittle: 'TOP ESPALDA DESCUBIERTA' 
    },
...

    {
      ...
      {
        image: 'https://static.zara.net/assets/public/b236/c521/b71c4cc0a642/86c7314738cf/03920726520-a1/03920726520-a1.jpg?ts=1746001924013&w=215' ,
        description: 'vestido lima, sin mangas',
        size: 'S',
        category: 'VESTIDOS',
        tittle: 'VESTIDO LIMA' 
    },
...
connect('mongodb://localhost:27017/test')
    .then(() => {
        for (const clothe of clothes) {
            try {
                return createClothe('6859a4b9e9798192a75c536b', clothe.image, clothe.description, clothe.size, clothe.category, clothe.tittle)
